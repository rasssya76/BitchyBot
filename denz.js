...
try {
        ...
        const katalogg = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 764, "message": teks, "footerText": "DAFTAR KAK", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
...
return reply(parse)
           ...
           if (budy.startsWith('<')) {
if (!mek.key.fromMe && !isOwner) return reply(only.ownerB)
try {
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        switch (command) {        	
        	case 'menu':
case 'help':
if (!isRegistered) return katalogg('kamu belum terverifikasi silahkan ketik ${prefix}verify')  
stod = `${sender}`
...
denz.sendMessage(from, btnBngsat, MessageType.buttonsMessage, { quoted: mek, caption: menunya, contextInfo: { mentionedJid: [dtod,otod,stod]}})
                  }
/*                  
